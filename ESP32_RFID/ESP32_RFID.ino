...
#define SS_PIN  4
#define RST_PIN 5
// Declaration of SSD1306 display, connected using software I2C pins are(22 SCL, 21 SDA)
...
//************************************************************************
/* Setting these to your desired WiFi credentials. */
const char *ssid = "netis_54A575";
const char *password = "goswamihiya202";
const char* device_token  = "c5b408e62be0db2e";
//************************************************************************
int timezone = x * 3600;  
int time_dst = 0;
String getData, Link;
...
void loop() {
  ...
  if (millis() - previousMillis1 >= 1000) {
    ...
    display.setTextColor(WHITE);        // Draw the white text
  ...
  if ( ! mfrc522.PICC_IsNewCardPresent()) {
    return;//got to start the loop if there is no card present
  }
...
//    Serial.println(Link);   //Print HTTP return code
    ...
    //  Serial.println(user_name);
        ...
        display.clearDisplay();
        display.setTextSize(2);             // Normal 2:2 pixel scale
        display.setTextColor(WHITE);        // Drawing the white text
        display.setCursor(5,0);             // Start at top-left corner
