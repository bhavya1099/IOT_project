...
<main>
  <h1 class="slideInDown animated" "text-color:white">Login with the Admin E-mail and Password</h1>
    ...
    <div class="login-page">
      <div class="form">
        ...
        <form class="login-form" action="ac_login.php" method="post" enctype="multipart/form-data">
          ...
          <p class="message" "colour:pink">Forgot your Password? <a href="#" "colour:white">Reset your password</a></p>
        </form>
      </div>
    </div>
  </div>
