...
<section class="container py-lg-5">>
  <!--User table-->
    <h1 class="slideInDown animated" style="color:#C3073F">Users daily logs</h1>
    <div class="form-style-5">
      <button type="button" data-toggle="modal" data-target="#Filter-export" style="background:#C3073F">Log Filter/ Export to Excel</button>
    </div>
    <!-- Log filter -->
    <div class="modal fade bd-example-modal-lg" id="Filter-export" tabindex="-1" role="dialog" aria-labelledby="Filter/Export" aria-hidden="true">
      <div class="modal-dialog modal-dialog-centered modal-lg animate" role="document">
        <div class="modal-content" style="background:#C3073F">
          <div class="modal-header" style="background:#C3073F">
            <h3 class="modal-title" id="exampleModalLongTitle" style="background:#C3073F">Filter Your User Log:</h3>
          ...
          <form method="POST" action="Export_Excel.php" enctype="multipart/form-data">
            <div class="modal-body">
              <div class="container-fluid">
                ...
                <div class="row">
                  <div class="col-lg-4 col-sm-12" style="color:white">
    ...
    <!-- //Log filter -->
    <div class="slideInRight animated" style="background:#C3073F">
      <div id="userslog"></div>
    </div>
</section>
</main>
